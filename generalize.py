...
if __name__ == '__main__':
    ...
    weights_path = "weights/Resnet50_weights_test1_E_4.pth"
...
# Defining optimizers
    ...
    try:
        for t in range(epochs):
            ...
            torch.save(model.state_dict(), f"weights/Resnet50_weights_test{test_num}_E_{t}.pth")
            scheduler.step()
        ...
        torch.save(model.state_dict(), f"weights/Resnet50_weights_test{test_num}.pth")
        print("Model saved!")